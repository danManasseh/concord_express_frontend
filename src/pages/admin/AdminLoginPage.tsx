  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.user.role !== 'admin') {
        setError('Access denied. Station Admin credentials required.');
        authService.logout();
        setIsLoading(false);
        return;
      }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-3 text-center pb-6">
            <div className="mx-auto w-16 h-16 bg-gradient-to-br from-indigo-600 to-blue-600 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div>
              ...
              <CardDescription className="mt-2">
                Access your station management dashboard
              </CardDescription>
            </div>
          </CardHeader>
